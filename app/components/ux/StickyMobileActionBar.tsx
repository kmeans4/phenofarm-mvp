    ...
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-pf-line bg-pf-surface/95 px-4 py-3 shadow-[0_-10px_25px_rgba(15,23,42,0.08)] backdrop-blur sm:hidden">
      ...
      <div className={secondary ? 'grid grid-cols-2 gap-2' : 'flex'}>
        ...
        <button
          ...
          onClick={onPrimary}
          disabled={disabled}
          className="min-w-0 flex-1 rounded-lg bg-emerald-500 px-3 py-3 text-sm font-semibold text-[#032116] hover:bg-emerald-400 disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 ring-offset-pf-canvas"
        >
          {primaryLabel}
        </button>
      </div>
