    ...
    <div ref={containerRef} className="relative">
      <div className="relative">
        <input
          ...
          disabled={disabled}
          className={`w-full rounded-lg border border-gray-300 px-4 py-2 pr-10 focus:border-green-500 focus:ring-1 focus:ring-green-500 disabled:bg-gray-100 disabled:cursor-not-allowed ${className}`}
        />
        {isLoading && (
